...
{ ERASE_METHOD_PTR(UTypedElementAssetDataInterface, GetAllReferencedAssetDatas, (const FScriptTypedElementHandle&), ERASE_ARGUMENT_PACK(TArray<FAssetData>)) },
...
{ ERASE_METHOD_PTR(UTypedElementHierarchyInterface, GetChildElements, (const FScriptTypedElementHandle&, TArray<FScriptTypedElementHandle>, const bool), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UTypedElementPrimitiveCustomDataInterface, SetCustomData, (const FScriptTypedElementHandle&, const TArray<float>&, bool), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UAssetRegistry, GetAllAssets, (TArray<FAssetData>, bool)const, ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(UAssetRegistry, GetAllCachedPaths, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAssetRegistry, GetAncestorClassNames, (FTopLevelAssetPath, TArray<FTopLevelAssetPath>)const, ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(UAssetRegistry, GetAssetByObjectPath, (const FName, bool)const, ERASE_ARGUMENT_PACK(FAssetData)) },
{ ERASE_METHOD_PTR(UAssetRegistry, GetAssets, (const FARFilter&, TArray<FAssetData>, bool)const, ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(UAssetRegistry, GetAssetsByClass, (FTopLevelAssetPath, TArray<FAssetData>, bool)const, ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(UAssetRegistry, GetAssetsByPackageName, (FName, TArray<FAssetData>, bool, bool)const, ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(UAssetRegistry, GetAssetsByPath, (FName, TArray<FAssetData>, bool, bool)const, ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(UAssetRegistry, GetAssetsByPaths, (TArray<FName>, TArray<FAssetData>, bool, bool)const, ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(UAssetRegistry, GetDerivedClassNames, (const TArray<FTopLevelAssetPath>&, const TSet<FTopLevelAssetPath>&, TSet<FTopLevelAssetPath>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAssetRegistry, GetSubPaths, (FString, TArray<FString>, bool)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UAssetRegistry, K2_GetDependencies, (FName, const FAssetRegistryDependencyOptions&, TArray<FName>)const, ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(UAssetRegistry, K2_GetReferencers, (FName, const FAssetRegistryDependencyOptions&, TArray<FName>)const, ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(UAssetRegistry, PrioritizeSearchPath, (FString), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAssetRegistry, RunAssetsThroughFilter, (TArray<FAssetData>&, const FARFilter&)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAssetRegistry, ScanFilesSynchronous, (const TArray<FString>&, bool), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAssetRegistry, ScanModifiedAssetFiles, (const TArray<FString>&), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAssetRegistry, ScanPathsSynchronous, (const TArray<FString>&, bool, bool), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAssetRegistry, SearchAllAssets, (bool), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAssetRegistry, UseFilterToExcludeAssets, (TArray<FAssetData>&, const FARFilter&)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UAudioParameterControllerInterface, SetBoolArrayParameter, (FName, const TArray<bool>&), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAudioParameterControllerInterface, SetBoolParameter, (FName, bool), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAudioParameterControllerInterface, SetFloatArrayParameter, (FName, const TArray<float>&), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAudioParameterControllerInterface, SetFloatParameter, (FName, float), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAudioParameterControllerInterface, SetIntArrayParameter, (FName, const TArray<int32>&), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAudioParameterControllerInterface, SetIntParameter, (FName, int32), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAudioParameterControllerInterface, SetObjectArrayParameter, (FName, const TArray<UObject*>&), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAudioParameterControllerInterface, SetObjectParameter, (FName, UObject*), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAudioParameterControllerInterface, SetParameters_Blueprint, (const TArray<FAudioParameter>&), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAudioParameterControllerInterface, SetStringArrayParameter, (FName, const TArray<FString>&), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangePipelineBase, ScriptedExecutePipeline, (UInterchangeBaseNodeContainer*, const TArray<UInterchangeSourceData*>&, FString), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeBaseNode, GetTargetNodeUids, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeBaseNodeContainer, GetNodeChildrenUids, (FString)const, ERASE_ARGUMENT_PACK(TArray<FString>)) },
{ ERASE_METHOD_PTR(UInterchangeBaseNodeContainer, GetNodes, (const UClass*, TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UInterchangeBaseNodeContainer, GetRoots, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeFactoryBaseNode, GetFactoryDependencies, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(AActor, GetAllChildActors, (TArray<AActor*>, bool)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(AActor, GetAttachedActors, (TArray<AActor*>, bool, bool)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(AActor, GetComponentsByInterface, (TSubclassOf<UInterface>)const, ERASE_ARGUMENT_PACK(TArray<UActorComponent*>)) },
{ ERASE_METHOD_PTR(AActor, GetComponentsByTag, (TSubclassOf<UActorComponent>, FName)const, ERASE_ARGUMENT_PACK(TArray<UActorComponent*>)) },
...
{ ERASE_METHOD_PTR(AActor, GetOverlappingActors, (TArray<AActor*>, TSubclassOf<AActor>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(AActor, GetOverlappingComponents, (TArray<UPrimitiveComponent*>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(AActor, K2_GetComponentsByClass, (TSubclassOf<UActorComponent>)const, ERASE_ARGUMENT_PACK(TArray<UActorComponent*>)) },
...
{ ERASE_METHOD_PTR(USequencerOutlinerScriptingObject, GetChildren, (FSequencerViewModelScriptingStruct, FName)const, ERASE_ARGUMENT_PACK(TArray<FSequencerViewModelScriptingStruct>)) },
...
{ ERASE_METHOD_PTR(USequencerOutlinerScriptingObject, GetSelection, ()const, ERASE_ARGUMENT_PACK(TArray<FSequencerViewModelScriptingStruct>)) },
...
{ ERASE_METHOD_PTR(UContentBrowserAssetContextMenuContext, GetSelectedObjects, ()const, ERASE_ARGUMENT_PACK(TArray<UObject*>)) },
{ ERASE_METHOD_PTR(UContentBrowserAssetContextMenuContext, LoadSelectedObjects, (TSet<FName>)const, ERASE_ARGUMENT_PACK(TArray<UObject*>)) },
{ ERASE_METHOD_PTR(UContentBrowserAssetContextMenuContext, LoadSelectedObjectsIfNeeded, ()const, ERASE_ARGUMENT_PACK(TArray<UObject*>)) },
//END UContentBrowserAssetContextMenuContext

{ ERASE_METHOD_PTR(USequencerModuleOutlinerScriptingObject, GetNextKey, (const TArray<FSequencerViewModelScriptingStruct>&, FFrameNumber, EMovieSceneTimeUnit)const, ERASE_ARGUMENT_PACK(FFrameNumber)) },
{ ERASE_METHOD_PTR(USequencerModuleOutlinerScriptingObject, GetPreviousKey, (const TArray<FSequencerViewModelScriptingStruct>&, FFrameNumber, EMovieSceneTimeUnit)const, ERASE_ARGUMENT_PACK(FFrameNumber)) },
...
{ ERASE_METHOD_PTR(UUserWidget, GetExtensions, (TSubclassOf<UUserWidgetExtension>)const, ERASE_ARGUMENT_PACK(TArray<UUserWidgetExtension*>)) },
...
{ ERASE_METHOD_PTR(USceneComponent, GetAllSocketNames, ()const, ERASE_ARGUMENT_PACK(TArray<FName>)) },
...
{ ERASE_METHOD_PTR(USceneComponent, GetChildrenComponents, (bool, TArray<USceneComponent*>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(USceneComponent, GetParentComponents, (TArray<USceneComponent*>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UPrimitiveComponent, GetExcludeForSpecificHLODLevels, ()const, ERASE_ARGUMENT_PACK(TArray<int32>)) },
...
{ ERASE_METHOD_PTR(UPrimitiveComponent, GetMaterialSlotNames, ()const, ERASE_ARGUMENT_PACK(TArray<FName>)) },
...
{ ERASE_METHOD_PTR(UPrimitiveComponent, GetOverlappingActors, (TArray<AActor*>, TSubclassOf<AActor>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UPrimitiveComponent, GetOverlappingComponents, (TArray<UPrimitiveComponent*>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UPrimitiveComponent, SetExcludeForSpecificHLODLevels, (const TArray<int32>&), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UMeshComponent, GetMaterials, ()const, ERASE_ARGUMENT_PACK(TArray<UMaterialInterface*>)) },
...
{ ERASE_METHOD_PTR(UViewportWorldInteraction, GetInteractors, ()const, ERASE_ARGUMENT_PACK(const TArray<UViewportInteractor*>&)) },
...
{ ERASE_METHOD_PTR(UEnvQueryInstanceBlueprintWrapper, GetQueryResultsAsActors, (TArray<AActor*>)const, ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(UEnvQueryInstanceBlueprintWrapper, GetQueryResultsAsLocations, (TArray<FVector>)const, ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(UEnvQueryInstanceBlueprintWrapper, GetResultsAsActors, ()const, ERASE_ARGUMENT_PACK(TArray<AActor*>)) },
{ ERASE_METHOD_PTR(UEnvQueryInstanceBlueprintWrapper, GetResultsAsLocations, ()const, ERASE_ARGUMENT_PACK(TArray<FVector>)) },
...
{ ERASE_METHOD_PTR(UAIPerceptionComponent, GetCurrentlyPerceivedActors, (TSubclassOf<UAISense>, TArray<AActor*>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAIPerceptionComponent, GetKnownPerceivedActors, (TSubclassOf<UAISense>, TArray<AActor*>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAIPerceptionComponent, GetPerceivedHostileActors, (TArray<AActor*>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAIPerceptionComponent, GetPerceivedHostileActorsBySense, (const TSubclassOf<UAISense>, TArray<AActor*>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UAISense_Blueprint, GetAllListenerActors, (TArray<AActor*>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAISense_Blueprint, GetAllListenerComponents, (TArray<UAIPerceptionComponent*>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UGeometryCollectionComponent, GetDamageThreshold, ()const, ERASE_ARGUMENT_PACK(TArray<float>)) },
...
{ ERASE_METHOD_PTR(UGeometryCollectionComponent, GetInitialLocalRestTransforms, ()const, ERASE_ARGUMENT_PACK(TArray<FTransform>)) },
...
{ ERASE_METHOD_PTR(UGeometryCollectionComponent, SetDamageThreshold, (const TArray<float>&), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UGeometryCollectionComponent, SetPerParticleCollisionProfileName, (const TArray<int32>&, FName), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UCameraComponent, AddOrUpdateBlendable, (TScriptInterface<IBlendableInterface>, float), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UCameraComponent, RemoveBlendable, (TScriptInterface<IBlendableInterface>), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UDataLayerEditorSubsystem, AppendActorsFromDataLayer, (UDataLayerInstance*, TArray<AActor*>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UDataLayerEditorSubsystem, AppendActorsFromDataLayers, (const TArray<UDataLayerInstance*>&, TArray<AActor*>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UDataLayerEditorSubsystem, GetActorsFromDataLayer, (UDataLayerInstance*)const, ERASE_ARGUMENT_PACK(TArray<AActor*>)) },
{ ERASE_METHOD_PTR(UDataLayerEditorSubsystem, GetActorsFromDataLayers, (const TArray<UDataLayerInstance*>&)const, ERASE_ARGUMENT_PACK(TArray<AActor*>)) },
...
{ ERASE_METHOD_PTR(UDataLayerEditorSubsystem, GetDataLayerInstances, (const TArray<UDataLayerAsset*>)const, ERASE_ARGUMENT_PACK(TArray<UDataLayerInstance*>)) },
...
{ ERASE_METHOD_PTR(UDataLayerEditorSubsystem, SelectActorsInDataLayers, (const TArray<UDataLayerInstance*>&, const bool, const bool, const bool), ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(USubobjectDataSubsystem, CanCopySubobjects, (const TArray<FSubobjectDataHandle>&)const, ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(USubobjectDataSubsystem, DeleteSubobjects, (const FSubobjectDataHandle&, const TArray<FSubobjectDataHandle>&, UBlueprint*), ERASE_ARGUMENT_PACK(int32)) },
...
{ ERASE_METHOD_PTR(USubobjectDataSubsystem, K2_DeleteSubobjectsFromInstance, (const FSubobjectDataHandle&, const TArray<FSubobjectDataHandle>&), ERASE_ARGUMENT_PACK(int32)) },
...
{ ERASE_METHOD_PTR(USubobjectDataSubsystem, K2_GatherSubobjectDataForBlueprint, (UBlueprint*, TArray<FSubobjectDataHandle>), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(USubobjectDataSubsystem, K2_GatherSubobjectDataForInstance, (AActor*, TArray<FSubobjectDataHandle>), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(USubobjectEditorMenuContext, GetSelectedObjects, ()const, ERASE_ARGUMENT_PACK(TArray<UObject*>)) },
...
{ ERASE_METHOD_PTR(UListViewBase, GetDisplayedEntryWidgets, ()const, ERASE_ARGUMENT_PACK(const TArray<UUserWidget*>&)) },
...
{ ERASE_METHOD_PTR(UListView, BP_GetSelectedItems, (TArray<UObject*>)const, ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(UListView, BP_SetListItems, (const TArray<UObject*>&), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UListView, GetListItems, ()const, ERASE_ARGUMENT_PACK(const TArray<UObject*>&)) },
...
{ ERASE_METHOD_PTR(UMovieSceneSequence, FindBindingsByTag, (FName)const, ERASE_ARGUMENT_PACK(const TArray<FMovieSceneObjectBindingID>&)) },
...
{ ERASE_METHOD_PTR(UPanelWidget, GetAllChildren, ()const, ERASE_ARGUMENT_PACK(TArray<UWidget*>)) },
...
{ ERASE_METHOD_PTR(UDynamicEntryBoxBase, GetAllEntries, ()const, ERASE_ARGUMENT_PACK(const TArray<UUserWidget*>&)) },
...
{ ERASE_METHOD_PTR(UImage, SetBrushFromAtlasInterface, (TScriptInterface<ISlateTextureAtlasInterface>, bool), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UContentBrowserDataSubsystem, GetActiveDataSources, ()const, ERASE_ARGUMENT_PACK(TArray<FName>)) },
{ ERASE_METHOD_PTR(UContentBrowserDataSubsystem, GetAvailableDataSources, ()const, ERASE_ARGUMENT_PACK(TArray<FName>)) },
...
{ ERASE_METHOD_PTR(UContentBrowserDataSubsystem, GetItemsAtPath, (const FName, const EContentBrowserItemTypeFilter)const, ERASE_ARGUMENT_PACK(TArray<FContentBrowserItem>)) },
{ ERASE_METHOD_PTR(UContentBrowserDataSubsystem, GetItemsUnderPath, (const FName, const FContentBrowserDataFilter&)const, ERASE_ARGUMENT_PACK(TArray<FContentBrowserItem>)) },
...
{ ERASE_METHOD_PTR(UAssetImportData, K2_ExtractFilenames, ()const, ERASE_ARGUMENT_PACK(TArray<FString>)) },
...
{ ERASE_METHOD_PTR(UInterchangeAssetImportData, GetPipelines, ()const, ERASE_ARGUMENT_PACK(TArray<UObject*>)) },
...
{ ERASE_METHOD_PTR(UInterchangeAssetImportData, ScriptExtractDisplayLabels, ()const, ERASE_ARGUMENT_PACK(TArray<FString>)) },
{ ERASE_METHOD_PTR(UInterchangeAssetImportData, ScriptExtractFilenames, ()const, ERASE_ARGUMENT_PACK(TArray<FString>)) },
...
{ ERASE_METHOD_PTR(UInterchangeAssetImportData, SetPipelines, (const TArray<UObject*>&)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UAssetTools, BeginAdvancedCopyPackages, (const TArray<FName>&, FString, const FAdvancedCopyCompletedEvent&)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UAssetTools, ExportAssets, (const TArray<FString>&, FString), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAssetTools, ExportAssetsWithDialog, (const TArray<FString>&, bool), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAssetTools, FindSoftReferencesToObject, (FSoftObjectPath, TArray<UObject*>), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAssetTools, ImportAssetsAutomated, (const UAutomatedAssetImportData*), ERASE_ARGUMENT_PACK(TArray<UObject*>)) },
{ ERASE_METHOD_PTR(UAssetTools, ImportAssetsWithDialog, (FString), ERASE_ARGUMENT_PACK(TArray<UObject*>)) },
{ ERASE_METHOD_PTR(UAssetTools, ImportAssetTasks, (const TArray<UAssetImportTask*>&), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAssetTools, MigratePackages, (const TArray<FName>&, FString, const FMigrationOptions&)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAssetTools, OpenEditorForAssets, (const TArray<UObject*>&), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAssetTools, RenameAssets, (const TArray<FAssetRenameData>&), ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(UAssetTools, RenameAssetsWithDialog, (const TArray<FAssetRenameData>&, bool), ERASE_ARGUMENT_PACK(EAssetRenameResult)) },
{ ERASE_METHOD_PTR(UAssetTools, RenameReferencingSoftObjectPaths, (const TArray<UPackage*>, const TMap<FSoftObjectPath,FSoftObjectPath>&), ERASE_ARGUMENT_PACK(void)) },
//END UAssetTools
...
{ ERASE_METHOD_PTR(UAnimationGraph, GetGraphNodesOfClass, (TSubclassOf<UAnimGraphNode_Base>, TArray<UAnimGraphNode_Base*>, bool), ERASE_ARGUMENT_PACK(void)) },
//END UAnimationGraph
...
{ ERASE_METHOD_PTR(USkinnedMeshComponent, SetPostSkinningOffsets, (int32, TArray<FVector>), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(USkinnedMeshComponent, SetPreSkinningOffsets, (int32, TArray<FVector>), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(USkinnedMeshComponent, SetSkinWeightOverride, (int32, const TArray<FSkelMeshSkinWeightInfo>&), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(USkinnedMeshComponent, SetSkinWeightProfile, (FName), ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(USkinnedMeshComponent, SetVertexColorOverride_LinearColor, (int32, const TArray<FLinearColor>&), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(USkeletalMeshComponent, GetLinkedAnimGraphInstancesByTag, (FName, TArray<UAnimInstance*>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UAnimInstance, GetActiveCurveNames, (EAnimCurveType, TArray<FName>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAnimInstance, GetAllCurveNames, (TArray<FName>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UAnimInstance, GetLinkedAnimGraphInstancesByTag, (FName, TArray<UAnimInstance*>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UAnimInstance, GetLinkedAnimLayerInstancesByGroup, (FName, TArray<UAnimInstance*>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UMovieSceneParameterSection, GetParameterNames, (TSet<FName>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UMovieSceneDataLayerSection, GetDataLayerAssets, ()const, ERASE_ARGUMENT_PACK(const TArray<UDataLayerAsset*>&)) },
{ ERASE_METHOD_PTR(UMovieSceneDataLayerSection, GetDataLayers, ()const, ERASE_ARGUMENT_PACK(const TArray<FActorDataLayer>&)) },
...
{ ERASE_METHOD_PTR(UMovieSceneLevelVisibilitySection, GetLevelNames, ()const, ERASE_ARGUMENT_PACK(const TArray<FName>&)) },
...
{ ERASE_METHOD_PTR(USoundWave, GetCuePoints, ()const, ERASE_ARGUMENT_PACK(TArray<FSoundWaveCuePoint>)) },
{ ERASE_METHOD_PTR(USoundWave, GetLoopRegions, ()const, ERASE_ARGUMENT_PACK(TArray<FSoundWaveCuePoint>)) },
...
{ ERASE_METHOD_PTR(USynthComponent, SetModulationRouting, (const TSet<USoundModulatorBase*>&, const EModulationDestination, const EModulationRouting), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UMediaPlayer, GetMediaMetadataItems, ()const, ERASE_ARGUMENT_PACK(TMap<FString,FMediaMetadataItemsBPT>)) },
...
{ ERASE_METHOD_PTR(UMediaPlayer, GetSupportedRates, (TArray<FFloatRange>, bool)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UMediaSoundComponent, SetSpectralAnalysisSettings, (TArray<float>, EMediaSoundComponentFFTSize), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(ALevelSequenceActor, FindNamedBindings, (FName)const, ERASE_ARGUMENT_PACK(const TArray<FMovieSceneObjectBindingID>&)) },
...
{ ERASE_METHOD_PTR(ALevelSequenceActor, SetBinding, (FMovieSceneObjectBindingID, const TArray<AActor*>&, bool), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(ALevelSequenceActor, SetBindingByTag, (FName, const TArray<AActor*>&, bool), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UActorGroupingUtils, CanGroupActors, (const TArray<AActor*>&)const, ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(UAssetEditorSubsystem, OpenEditorForAssets, (const TArray<UObject*>&, const EAssetTypeActivationOpenedMethod), ERASE_ARGUMENT_PACK(bool)) },
//END UAssetEditorSubsystem

{ ERASE_METHOD_PTR(UAssetEditorToolkitMenuContext, GetEditingObjects, ()const, ERASE_ARGUMENT_PACK(TArray<UObject*>)) },
//END UAssetEditorToolkitMenuContext

{ ERASE_METHOD_PTR(UAssetImportTask, GetObjects, ()const, ERASE_ARGUMENT_PACK(const TArray<UObject*>&)) },
...
{ ERASE_METHOD_PTR(UEditorActorSubsystem, ConvertActors, (const TArray<AActor*>&, TSubclassOf<AActor>, FString), ERASE_ARGUMENT_PACK(TArray<AActor*>)) },
...
{ ERASE_METHOD_PTR(UEditorActorSubsystem, DuplicateActors, (const TArray<AActor*>&, UWorld*, FVector), ERASE_ARGUMENT_PACK(TArray<AActor*>)) },
...
{ ERASE_METHOD_PTR(UEditorAssetSubsystem, FindPackageReferencersForAsset, (FString, bool), ERASE_ARGUMENT_PACK(TArray<FString>)) },
...
{ ERASE_METHOD_PTR(UEditorAssetSubsystem, GetTagValues, (FString), ERASE_ARGUMENT_PACK(TMap<FName,FString>)) },
{ ERASE_METHOD_PTR(UEditorAssetSubsystem, ListAssets, (FString, bool, bool), ERASE_ARGUMENT_PACK(TArray<FString>)) },
{ ERASE_METHOD_PTR(UEditorAssetSubsystem, ListAssetsByTagValue, (FName, FString), ERASE_ARGUMENT_PACK(TArray<FString>)) },
...
{ ERASE_METHOD_PTR(UEditorAssetSubsystem, SaveLoadedAssets, (const TArray<UObject*>&, bool), ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(ULayersSubsystem, AddAllLayerNamesTo, (TArray<FName>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(ULayersSubsystem, AddAllLayersTo, (TArray<ULayer*>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(ULayersSubsystem, AppendActorsFromLayer, (const FName&, TArray<AActor*>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(ULayersSubsystem, AppendActorsFromLayers, (const TArray<FName>&, TArray<AActor*>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(ULayersSubsystem, GetActorsFromLayer, (const FName&)const, ERASE_ARGUMENT_PACK(TArray<AActor*>)) },
{ ERASE_METHOD_PTR(ULayersSubsystem, GetActorsFromLayers, (const TArray<FName>&)const, ERASE_ARGUMENT_PACK(TArray<AActor*>)) },
{ ERASE_METHOD_PTR(ULayersSubsystem, GetLayer, (const FName&)const, ERASE_ARGUMENT_PACK(ULayer*)) },
{ ERASE_METHOD_PTR(ULayersSubsystem, GetSelectedActors, ()const, ERASE_ARGUMENT_PACK(TArray<AActor*>)) },
...
{ ERASE_METHOD_PTR(ULayersSubsystem, RemoveActorFromLayers, (AActor*, const TArray<FName>&, const bool), ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(ULayersSubsystem, RemoveActorsFromLayer, (const TArray<AActor*>&, const FName&, const bool), ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(ULayersSubsystem, RemoveActorsFromLayers, (const TArray<AActor*>&, const TArray<FName>&, const bool), ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(ULayersSubsystem, SelectActorsInLayers, (const TArray<FName>&, const bool, const bool, const bool), ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(UInstancedStaticMeshComponent, AddInstances, (const TArray<FTransform>&, bool, bool, bool), ERASE_ARGUMENT_PACK(TArray<int32>)) },
...
{ ERASE_METHOD_PTR(UInstancedStaticMeshComponent, BatchUpdateInstancesTransforms, (int32, const TArray<FTransform>&, bool, bool, bool), ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(UInstancedStaticMeshComponent, GetInstancesOverlappingBox, (const FBox&, bool)const, ERASE_ARGUMENT_PACK(TArray<int32>)) },
{ ERASE_METHOD_PTR(UInstancedStaticMeshComponent, GetInstancesOverlappingSphere, (const FVector&, float, bool)const, ERASE_ARGUMENT_PACK(TArray<int32>)) },
...
{ ERASE_METHOD_PTR(UInstancedStaticMeshComponent, RemoveInstances, (const TArray<int32>&), ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(ALandscape, GetTargetLayerNames, (bool)const, ERASE_ARGUMENT_PACK(TArray<FName>)) },
...
{ ERASE_METHOD_PTR(UDataLayerManager, GetDataLayerInstances, ()const, ERASE_ARGUMENT_PACK(TArray<UDataLayerInstance*>)) },
...
{ ERASE_METHOD_PTR(UAnimationDataController, GetModelInterface, ()const, ERASE_ARGUMENT_PACK(TScriptInterface<IAnimationDataModel>)) },
...
{ ERASE_METHOD_PTR(UAnimationDataController, SetBoneTrackKeys, (FName, const TArray<FVector>&, const TArray<FQuat>&, const TArray<FVector>&, bool), ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(UAnimationDataController, SetCurveKeys, (const FAnimationCurveIdentifier&, const TArray<FRichCurveKey>&, bool), ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(UAnimationDataController, SetFrameRate, (FFrameRate, bool), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAnimationDataController, SetModel, (TScriptInterface<IAnimationDataModel>), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UAnimationDataController, SetTransformCurveKeys, (const FAnimationCurveIdentifier&, const TArray<FTransform>&, const TArray<float>&, bool), ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(UAnimationDataModel, GetBoneAnimationTracks, ()const, ERASE_ARGUMENT_PACK(const TArray<FBoneAnimationTrack>&)) },
...
{ ERASE_METHOD_PTR(UAnimationDataModel, GetBoneTrackNames, (TArray<FName>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(APlayerCameraManager, AddGenericCameraLensEffect, (TSubclassOf<AActor>), ERASE_ARGUMENT_PACK(TScriptInterface<ICameraLensEffectInterface>)) },
...
{ ERASE_METHOD_PTR(APlayerCameraManager, RemoveGenericCameraLensEffect, (TScriptInterface<ICameraLensEffectInterface>), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(USceneCaptureComponent2D, AddOrUpdateBlendable, (TScriptInterface<IBlendableInterface>, float), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(USceneCaptureComponent2D, CaptureScene, (), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(USceneCaptureComponent2D, RemoveBlendable, (TScriptInterface<IBlendableInterface>), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UAnimationSettings, GetBoneCustomAttributeNamesToImport, ()const, ERASE_ARGUMENT_PACK(TArray<FString>)) },
...
{ ERASE_METHOD_PTR(UAnimSequence, AddBoneFloatCustomAttribute, (const FName&, const FName&, const TArray<float>&, const TArray<float>&), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAnimSequence, AddBoneIntegerCustomAttribute, (const FName&, const FName&, const TArray<float>&, const TArray<int32>&), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UAnimSequence, AddBoneStringCustomAttribute, (const FName&, const FName&, const TArray<float>&, const TArray<FString>&), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UPoseAsset, GetPoseNames, (TArray<FName>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UCameraLensEffectInterface, GetParticleComponents, ()const, ERASE_ARGUMENT_PACK(TArray<UFXSystemComponent*>)) },
...
{ ERASE_METHOD_PTR(APlayerController, GetHitResultUnderCursorForObjects, (const TArray<TEnumAsByte<EObjectTypeQuery> >&, bool, FHitResult)const, ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(APlayerController, GetHitResultUnderFingerForObjects, (TEnumAsByte<ETouchIndex::Type>, const TArray<TEnumAsByte<EObjectTypeQuery> >&, bool, FHitResult)const, ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(APlayerController, GetStreamingSourceShapes, (TArray<FStreamingSourceShape>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UAudioComponent, GetCookedFFTData, (const TArray<float>&, TArray<FSoundWaveSpectralData>), ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(UAudioComponent, SetModulationRouting, (const TSet<USoundModulatorBase*>&, const EModulationDestination, const EModulationRouting), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UPostProcessComponent, AddOrUpdateBlendable, (TScriptInterface<IBlendableInterface>, float), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(USplineComponent, AddPoints, (const TArray<FSplinePoint>&, bool), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(USplineComponent, ConvertSplineSegmentToPolyLine, (int32, TEnumAsByte<ESplineCoordinateSpace::Type>, const float, TArray<FVector>)const, ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(USplineComponent, ConvertSplineToPolyLine, (TEnumAsByte<ESplineCoordinateSpace::Type>, const float, TArray<FVector>)const, ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(USplineComponent, ConvertSplineToPolyline_InDistanceRange, (TEnumAsByte<ESplineCoordinateSpace::Type>, const float, float, float, TArray<FVector>, TArray<double>, bool)const, ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(USplineComponent, ConvertSplineToPolyline_InTimeRange, (TEnumAsByte<ESplineCoordinateSpace::Type>, const float, float, float, bool, TArray<FVector>, TArray<double>, bool)const, ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(USplineComponent, ConvertSplineToPolyLineWithDistances, (TEnumAsByte<ESplineCoordinateSpace::Type>, const float, TArray<FVector>, TArray<double>)const, ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(USplineComponent, DivideSplineIntoPolylineRecursive, (float, float, TEnumAsByte<ESplineCoordinateSpace::Type>, const float, TArray<FVector>)const, ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(USplineComponent, DivideSplineIntoPolylineRecursiveWithDistances, (float, float, TEnumAsByte<ESplineCoordinateSpace::Type>, const float, TArray<FVector>, TArray<double>)const, ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(USplineComponent, SetSplinePoints, (const TArray<FVector>&, TEnumAsByte<ESplineCoordinateSpace::Type>, bool), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(AHUD, GetActorsInSelectionRectangle, (TSubclassOf<AActor>, const FVector2D&, const FVector2D&, TArray<AActor*>, bool, bool), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UTypedElementCommonActions, K2_DuplicateSelectedElements, (const UTypedElementSelectionSet*, UWorld*, const FVector&), ERASE_ARGUMENT_PACK(TArray<FScriptTypedElementHandle>)) },
{ ERASE_METHOD_PTR(UTypedElementCommonActions, K2_PasteElements, (UTypedElementSelectionSet*, UWorld*, const FTypedElementPasteOptions&), ERASE_ARGUMENT_PACK(TArray<FScriptTypedElementHandle>)) },
{ ERASE_METHOD_PTR(UTypedElementCommonActions, K2_PasteNormalizedElements, (const FScriptTypedElementListProxy&, UWorld*, const FTypedElementPasteOptions&), ERASE_ARGUMENT_PACK(TArray<FScriptTypedElementHandle>)) },
{ ERASE_METHOD_PTR(UTypedElementCommonActions, PasteElementsFromString, (UTypedElementSelectionSet*, UWorld*, const FTypedElementPasteOptions&, FString), ERASE_ARGUMENT_PACK(TArray<FScriptTypedElementHandle>)) },
{ ERASE_METHOD_PTR(UTypedElementCommonActions, PasteNormalizedElementsFromString, (const FScriptTypedElementListProxy&, UWorld*, const FTypedElementPasteOptions&, FString), ERASE_ARGUMENT_PACK(TArray<FScriptTypedElementHandle>)) },
...
{ ERASE_METHOD_PTR(UMaterialParameterCollection, GetScalarParameterNames, ()const, ERASE_ARGUMENT_PACK(TArray<FName>)) },
...
{ ERASE_METHOD_PTR(UMaterialParameterCollection, GetVectorParameterNames, ()const, ERASE_ARGUMENT_PACK(TArray<FName>)) },
...
{ ERASE_METHOD_PTR(UClusterUnionComponent, AddComponentToCluster, (UPrimitiveComponent*, const TArray<int32>&, bool), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UClusterUnionComponent, RemoveComponentBonesFromCluster, (UPrimitiveComponent*, const TArray<int32>&), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(APostProcessVolume, AddOrUpdateBlendable, (TScriptInterface<IBlendableInterface>, float), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(USkeletalMesh, GetMaterials, ()const, ERASE_ARGUMENT_PACK(const TArray<FSkeletalMaterial>&)) },
{ ERASE_METHOD_PTR(USkeletalMesh, GetMeshClothingAssets, ()const, ERASE_ARGUMENT_PACK(const TArray<UClothingAssetBase*>&)) },
{ ERASE_METHOD_PTR(USkeletalMesh, GetMinLODForQualityLevels, (TMap<EPerQualityLevels,int32>, int32)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(USkeletalMesh, GetMorphTargetsPtrConv, ()const, ERASE_ARGUMENT_PACK(TArray<UMorphTarget*>)) },
{ ERASE_METHOD_PTR(USkeletalMesh, GetNodeMappingContainer, (UBlueprint*)const, ERASE_ARGUMENT_PACK(UNodeMappingContainer*)) },
{ ERASE_METHOD_PTR(USkeletalMesh, GetNodeMappingData, ()const, ERASE_ARGUMENT_PACK(const TArray<UNodeMappingContainer*>&)) },
...
{ ERASE_METHOD_PTR(USkeletalMesh, K2_GetAllMorphTargetNames, ()const, ERASE_ARGUMENT_PACK(TArray<FString>)) },
...
{ ERASE_METHOD_PTR(USkeletalMesh, SetMinLODForQualityLevels, (const TMap<EPerQualityLevels,int32>&, int32), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(USoundSubmix, AddSpectralAnalysisDelegate, (const UObject*, const TArray<FSoundSubmixSpectralAnalysisBandSettings>&, const FOnSubmixSpectralAnalysisBP&, float, float, bool, bool, float, float), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UStaticMesh, BuildFromStaticMeshDescriptions, (const TArray<UStaticMeshDescription*>&, bool, bool), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UStaticMesh, GetMinimumLODForPlatforms, (TMap<FName,int32>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UStaticMesh, GetMinimumLODForQualityLevel, (const FName&)const, ERASE_ARGUMENT_PACK(int32)) },
{ ERASE_METHOD_PTR(UStaticMesh, GetMinimumLODForQualityLevels, (TMap<FName,int32>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UStaticMesh, GetMinLODForQualityLevels, (TMap<EPerQualityLevels,int32>, int32)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UStaticMesh, GetSocketsByTag, (FString)const, ERASE_ARGUMENT_PACK(TArray<UStaticMeshSocket*>)) },
{ ERASE_METHOD_PTR(UStaticMesh, GetStaticMaterials, ()const, ERASE_ARGUMENT_PACK(const TArray<FStaticMaterial>&)) },
...
{ ERASE_METHOD_PTR(UStaticMesh, SetMinimumLODForPlatforms, (const TMap<FName,int32>&), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UStaticMesh, SetMinLODForQualityLevels, (const TMap<EPerQualityLevels,int32>&, int32), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UCanvas, K2_DrawMaterialTriangle, (UMaterialInterface*, TArray<FCanvasUVTri>), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UCanvas, K2_DrawTriangle, (UTexture*, TArray<FCanvasUVTri>), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInputSettings, GetActionMappingByName, (const FName, TArray<FInputActionKeyMapping>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UInputSettings, GetActionNames, (TArray<FName>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UInputSettings, GetAxisMappingByName, (const FName, TArray<FInputAxisKeyMapping>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UInputSettings, GetAxisNames, (TArray<FName>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UDataLayerSubsystem, GetActiveDataLayerNames, ()const, ERASE_ARGUMENT_PACK(const TSet<FName>&)) },
...
{ ERASE_METHOD_PTR(UDataLayerSubsystem, GetLoadedDataLayerNames, ()const, ERASE_ARGUMENT_PACK(const TSet<FName>&)) },
...
{ ERASE_METHOD_PTR(UWorldPartitionSubsystem, IsStreamingCompleted, (EWorldPartitionRuntimeCellState, const TArray<FWorldPartitionStreamingQuerySource>&, bool)const, ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(ASwitchActor, GetOptions, ()const, ERASE_ARGUMENT_PACK(TArray<AActor*>)) },
...
{ ERASE_METHOD_PTR(UAnimationSequenceBrowserContextMenuContext, GetSelectedObjects, ()const, ERASE_ARGUMENT_PACK(TArray<UObject*>)) },
...
{ ERASE_METHOD_PTR(UEnhancedPlayerMappableKeyProfile, GetMappedKeysInRow, (const FName, TArray<FKey>)const, ERASE_ARGUMENT_PACK(int32)) },
{ ERASE_METHOD_PTR(UEnhancedPlayerMappableKeyProfile, GetMappingNamesForKey, (const FKey&, TArray<FName>)const, ERASE_ARGUMENT_PACK(int32)) },
{ ERASE_METHOD_PTR(UEnhancedPlayerMappableKeyProfile, GetPlayerMappingRows, ()const, ERASE_ARGUMENT_PACK(const TMap<FName,FKeyMappingRow>&)) },
...
{ ERASE_METHOD_PTR(UEnhancedPlayerMappableKeyProfile, QueryPlayerMappedKeys, (const FPlayerMappableKeyQueryOptions&, TArray<FKey>)const, ERASE_ARGUMENT_PACK(int32)) },
...
{ ERASE_METHOD_PTR(UEnhancedInputUserSettings, FindMappingsInRow, (const FName)const, ERASE_ARGUMENT_PACK(const TSet<FPlayerKeyMapping>&)) },
...
{ ERASE_METHOD_PTR(UEnhancedInputSubsystemInterface, GetAllPlayerMappableActionKeyMappings, ()const, ERASE_ARGUMENT_PACK(TArray<FEnhancedActionKeyMapping>)) },
{ ERASE_METHOD_PTR(UEnhancedInputSubsystemInterface, GetAllPlayerMappedKeys, (const FName)const, ERASE_ARGUMENT_PACK(TArray<FKey>)) },
...
{ ERASE_METHOD_PTR(UEnhancedInputSubsystemInterface, InjectInputForAction, (const UInputAction*, FInputActionValue, const TArray<UInputModifier*>&, const TArray<UInputTrigger*>&), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UEnhancedInputSubsystemInterface, InjectInputForPlayerMapping, (const FName, FInputActionValue, const TArray<UInputModifier*>&, const TArray<UInputTrigger*>&), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UEnhancedInputSubsystemInterface, InjectInputVectorForAction, (const UInputAction*, FVector, const TArray<UInputModifier*>&, const TArray<UInputTrigger*>&), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UEnhancedInputSubsystemInterface, InjectInputVectorForPlayerMapping, (const FName, FVector, const TArray<UInputModifier*>&, const TArray<UInputTrigger*>&), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UEnhancedInputSubsystemInterface, QueryKeysMappedToAction, (const UInputAction*)const, ERASE_ARGUMENT_PACK(TArray<FKey>)) },
{ ERASE_METHOD_PTR(UEnhancedInputSubsystemInterface, QueryMapKeyInActiveContextSet, (const UInputMappingContext*, const UInputAction*, FKey, TArray<FMappingQueryIssue>, EMappingQueryIssue), ERASE_ARGUMENT_PACK(EMappingQueryResult)) },
{ ERASE_METHOD_PTR(UEnhancedInputSubsystemInterface, QueryMapKeyInContextSet, (const TArray<UInputMappingContext*>&, const UInputMappingContext*, const UInputAction*, FKey, TArray<FMappingQueryIssue>, EMappingQueryIssue), ERASE_ARGUMENT_PACK(EMappingQueryResult)) },
...
{ ERASE_METHOD_PTR(UEnhancedInputSubsystemInterface, StartContinuousInputInjectionForAction, (const UInputAction*, FInputActionValue, const TArray<UInputModifier*>&, const TArray<UInputTrigger*>&), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UEnhancedInputSubsystemInterface, StartContinuousInputInjectionForPlayerMapping, (const FName, FInputActionValue, const TArray<UInputModifier*>&, const TArray<UInputTrigger*>&), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UPlayerMappableInputConfig, GetKeysBoundToAction, (const UInputAction*)const, ERASE_ARGUMENT_PACK(TArray<FEnhancedActionKeyMapping>)) },
...
{ ERASE_METHOD_PTR(UPlayerMappableInputConfig, GetMappingContexts, ()const, ERASE_ARGUMENT_PACK(const TMap<TObjectPtr<UInputMappingContext> ,int32>&)) },
{ ERASE_METHOD_PTR(UPlayerMappableInputConfig, GetMetadata, ()const, ERASE_ARGUMENT_PACK(UObject*)) },
{ ERASE_METHOD_PTR(UPlayerMappableInputConfig, GetPlayerMappableKeys, ()const, ERASE_ARGUMENT_PACK(TArray<FEnhancedActionKeyMapping>)) },
...
{ ERASE_METHOD_PTR(URigVMHost, GetScriptAccessibleVariables, ()const, ERASE_ARGUMENT_PACK(TArray<FName>)) },
{ ERASE_METHOD_PTR(URigVMHost, GetSupportedEvents, ()const, ERASE_ARGUMENT_PACK(const TArray<FName>&)) },
...
{ ERASE_METHOD_PTR(URigVMBlueprint, GetAllModels, ()const, ERASE_ARGUMENT_PACK(TArray<URigVMGraph*>)) },
{ ERASE_METHOD_PTR(URigVMBlueprint, GetAutoVMRecompile, ()const, ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(URigVMBlueprint, GetAvailableRigVMStructs, ()const, ERASE_ARGUMENT_PACK(TArray<UStruct*>)) },
...
{ ERASE_METHOD_PTR(URigVMBlueprint, GetMemberVariables, ()const, ERASE_ARGUMENT_PACK(TArray<FRigVMGraphVariableDescription>)) },
...
{ ERASE_METHOD_PTR(URigVMNode, GetAggregateInputs, ()const, ERASE_ARGUMENT_PACK(TArray<URigVMPin*>)) },
{ ERASE_METHOD_PTR(URigVMNode, GetAggregateOutputs, ()const, ERASE_ARGUMENT_PACK(TArray<URigVMPin*>)) },
{ ERASE_METHOD_PTR(URigVMNode, GetAllPinsRecursively, ()const, ERASE_ARGUMENT_PACK(TArray<URigVMPin*>)) },
{ ERASE_METHOD_PTR(URigVMNode, GetDecoratorPins, ()const, ERASE_ARGUMENT_PACK(TArray<URigVMPin*>)) },
...
{ ERASE_METHOD_PTR(URigVMNode, GetLinkedSourceNodes, ()const, ERASE_ARGUMENT_PACK(TArray<URigVMNode*>)) },
{ ERASE_METHOD_PTR(URigVMNode, GetLinkedTargetNodes, ()const, ERASE_ARGUMENT_PACK(TArray<URigVMNode*>)) },
{ ERASE_METHOD_PTR(URigVMNode, GetLinks, ()const, ERASE_ARGUMENT_PACK(TArray<URigVMLink*>)) },
...
{ ERASE_METHOD_PTR(URigVMNode, GetOrphanedPins, ()const, ERASE_ARGUMENT_PACK(const TArray<URigVMPin*>&)) },
{ ERASE_METHOD_PTR(URigVMNode, GetPins, ()const, ERASE_ARGUMENT_PACK(const TArray<URigVMPin*>&)) },
...
{ ERASE_METHOD_PTR(URigVMNode, GetSupportedWorkflows, (ERigVMUserWorkflowType, const UObject*)const, ERASE_ARGUMENT_PACK(TArray<FRigVMUserWorkflow>)) },
...
{ ERASE_METHOD_PTR(URigVMController, CollapseNodes, (const TArray<FName>&, FString, bool, bool, bool), ERASE_ARGUMENT_PACK(URigVMCollapseNode*)) },
...
{ ERASE_METHOD_PTR(URigVMController, ExpandLibraryNode, (const FName&, bool, bool), ERASE_ARGUMENT_PACK(TArray<URigVMNode*>)) },
{ ERASE_METHOD_PTR(URigVMController, ExportNodesToText, (const TArray<FName>&, bool), ERASE_ARGUMENT_PACK(FString)) },
...
{ ERASE_METHOD_PTR(URigVMController, ImportNodesFromText, (FString, bool, bool), ERASE_ARGUMENT_PACK(TArray<FName>)) },
...
{ ERASE_METHOD_PTR(URigVMController, LocalizeFunctions, (TArray<FRigVMGraphFunctionIdentifier>, bool, bool, bool), ERASE_ARGUMENT_PACK(TMap<FRigVMGraphFunctionIdentifier,URigVMLibraryNode*>)) },
...
{ ERASE_METHOD_PTR(URigVMController, RemoveNodes, (TArray<URigVMNode*>, bool, bool), ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(URigVMController, RemoveNodesByName, (const TArray<FName>&, bool, bool), ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(URigVMController, SetNodeSelection, (const TArray<FName>&, bool, bool), ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(URigVMController, UnresolveTemplateNodes, (const TArray<FName>&, bool, bool), ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(URigVMController, UpgradeNodes, (const TArray<FName>&, bool, bool, bool), ERASE_ARGUMENT_PACK(TArray<URigVMNode*>)) },
...
{ ERASE_METHOD_PTR(URigVMGraph, GetContainedGraphs, (bool)const, ERASE_ARGUMENT_PACK(TArray<URigVMGraph*>)) },
...
{ ERASE_METHOD_PTR(URigVMGraph, GetEventNames, ()const, ERASE_ARGUMENT_PACK(TArray<FName>)) },
...
{ ERASE_METHOD_PTR(URigVMGraph, GetInputArguments, ()const, ERASE_ARGUMENT_PACK(TArray<FRigVMGraphVariableDescription>)) },
{ ERASE_METHOD_PTR(URigVMGraph, GetLinks, ()const, ERASE_ARGUMENT_PACK(const TArray<URigVMLink*>&)) },
{ ERASE_METHOD_PTR(URigVMGraph, GetLocalVariables, (bool)const, ERASE_ARGUMENT_PACK(TArray<FRigVMGraphVariableDescription>)) },
{ ERASE_METHOD_PTR(URigVMGraph, GetNodePath, ()const, ERASE_ARGUMENT_PACK(FString)) },
{ ERASE_METHOD_PTR(URigVMGraph, GetNodes, ()const, ERASE_ARGUMENT_PACK(const TArray<URigVMNode*>&)) },
{ ERASE_METHOD_PTR(URigVMGraph, GetOutputArguments, ()const, ERASE_ARGUMENT_PACK(TArray<FRigVMGraphVariableDescription>)) },
...
{ ERASE_METHOD_PTR(URigVMGraph, GetSelectNodes, ()const, ERASE_ARGUMENT_PACK(const TArray<FName>&)) },
{ ERASE_METHOD_PTR(URigVMGraph, GetVariableDescriptions, ()const, ERASE_ARGUMENT_PACK(TArray<FRigVMGraphVariableDescription>)) },
...
{ ERASE_METHOD_PTR(URigVMFunctionLibrary, GetFunctions, ()const, ERASE_ARGUMENT_PACK(TArray<URigVMLibraryNode*>)) },
...
{ ERASE_METHOD_PTR(URigVMPin, GetLinkedSourcePins, (bool)const, ERASE_ARGUMENT_PACK(TArray<URigVMPin*>)) },
{ ERASE_METHOD_PTR(URigVMPin, GetLinkedTargetPins, (bool)const, ERASE_ARGUMENT_PACK(TArray<URigVMPin*>)) },
{ ERASE_METHOD_PTR(URigVMPin, GetLinks, ()const, ERASE_ARGUMENT_PACK(const TArray<URigVMLink*>&)) },
...
{ ERASE_METHOD_PTR(URigVMPin, GetSourceLinks, (bool)const, ERASE_ARGUMENT_PACK(TArray<URigVMLink*>)) },
{ ERASE_METHOD_PTR(URigVMPin, GetSubPinPath, (const URigVMPin*, bool)const, ERASE_ARGUMENT_PACK(FString)) },
{ ERASE_METHOD_PTR(URigVMPin, GetSubPins, ()const, ERASE_ARGUMENT_PACK(const TArray<URigVMPin*>&)) },
{ ERASE_METHOD_PTR(URigVMPin, GetTargetLinks, (bool)const, ERASE_ARGUMENT_PACK(TArray<URigVMLink*>)) },
...
{ ERASE_METHOD_PTR(URigVMUserWorkflowRegistry, GetWorkflows, (ERigVMUserWorkflowType, const UScriptStruct*, const UObject*)const, ERASE_ARGUMENT_PACK(TArray<FRigVMUserWorkflow>)) },
...
{ ERASE_METHOD_PTR(UControlRig, CurrentControlSelection, ()const, ERASE_ARGUMENT_PACK(TArray<FName>)) },
...
{ ERASE_METHOD_PTR(URigHierarchy, GetAllKeys_ForBlueprint, (bool)const, ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
{ ERASE_METHOD_PTR(URigHierarchy, GetBoneKeys, (bool)const, ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
{ ERASE_METHOD_PTR(URigHierarchy, GetBoolArrayMetadata, (FRigElementKey, FName)const, ERASE_ARGUMENT_PACK(TArray<bool>)) },
{ ERASE_METHOD_PTR(URigHierarchy, GetBoolMetadata, (FRigElementKey, FName, bool)const, ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(URigHierarchy, GetChildren, (FRigElementKey, bool)const, ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
{ ERASE_METHOD_PTR(URigHierarchy, GetConnectorKeys, (bool)const, ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
{ ERASE_METHOD_PTR(URigHierarchy, GetConnectorStates, ()const, ERASE_ARGUMENT_PACK(TArray<FRigConnectorState>)) },
{ ERASE_METHOD_PTR(URigHierarchy, GetControlKeys, (bool)const, ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
...
{ ERASE_METHOD_PTR(URigHierarchy, GetCurveKeys, ()const, ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
...
{ ERASE_METHOD_PTR(URigHierarchy, GetFloatArrayMetadata, (FRigElementKey, FName)const, ERASE_ARGUMENT_PACK(TArray<float>)) },
...
{ ERASE_METHOD_PTR(URigHierarchy, GetInt32ArrayMetadata, (FRigElementKey, FName)const, ERASE_ARGUMENT_PACK(TArray<int32>)) },
...
{ ERASE_METHOD_PTR(URigHierarchy, GetKeys, (const TArray<int32>)const, ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
{ ERASE_METHOD_PTR(URigHierarchy, GetLinearColorArrayMetadata, (FRigElementKey, FName)const, ERASE_ARGUMENT_PACK(TArray<FLinearColor>)) },
...
{ ERASE_METHOD_PTR(URigHierarchy, GetMetadataNames, (FRigElementKey)const, ERASE_ARGUMENT_PACK(TArray<FName>)) },
...
{ ERASE_METHOD_PTR(URigHierarchy, GetNameArrayMetadata, (FRigElementKey, FName)const, ERASE_ARGUMENT_PACK(TArray<FName>)) },
...
{ ERASE_METHOD_PTR(URigHierarchy, GetNullKeys, (bool)const, ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
{ ERASE_METHOD_PTR(URigHierarchy, GetNumberOfParents, (FRigElementKey)const, ERASE_ARGUMENT_PACK(int32)) },
{ ERASE_METHOD_PTR(URigHierarchy, GetParents, (FRigElementKey, bool)const, ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
...
{ ERASE_METHOD_PTR(URigHierarchy, GetParentWeightArray, (FRigElementKey, bool)const, ERASE_ARGUMENT_PACK(TArray<FRigElementWeight>)) },
...
{ ERASE_METHOD_PTR(URigHierarchy, GetQuatArrayMetadata, (FRigElementKey, FName)const, ERASE_ARGUMENT_PACK(TArray<FQuat>)) },
{ ERASE_METHOD_PTR(URigHierarchy, GetQuatMetadata, (FRigElementKey, FName, FQuat)const, ERASE_ARGUMENT_PACK(FQuat)) },
{ ERASE_METHOD_PTR(URigHierarchy, GetReferenceKeys, (bool)const, ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
{ ERASE_METHOD_PTR(URigHierarchy, GetRigElementKeyArrayMetadata, (FRigElementKey, FName)const, ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
...
{ ERASE_METHOD_PTR(URigHierarchy, GetRigidBodyKeys, (bool)const, ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
{ ERASE_METHOD_PTR(URigHierarchy, GetRootElementKeys, ()const, ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
{ ERASE_METHOD_PTR(URigHierarchy, GetRotatorArrayMetadata, (FRigElementKey, FName)const, ERASE_ARGUMENT_PACK(TArray<FRotator>)) },
...
{ ERASE_METHOD_PTR(URigHierarchy, GetSelectedKeys, (ERigElementType)const, ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
{ ERASE_METHOD_PTR(URigHierarchy, GetSocketKeys, (bool)const, ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
{ ERASE_METHOD_PTR(URigHierarchy, GetSocketStates, ()const, ERASE_ARGUMENT_PACK(TArray<FRigSocketState>)) },
{ ERASE_METHOD_PTR(URigHierarchy, GetTags, (FRigElementKey)const, ERASE_ARGUMENT_PACK(TArray<FName>)) },
{ ERASE_METHOD_PTR(URigHierarchy, GetTransformArrayMetadata, (FRigElementKey, FName)const, ERASE_ARGUMENT_PACK(TArray<FTransform>)) },
{ ERASE_METHOD_PTR(URigHierarchy, GetTransformMetadata, (FRigElementKey, FName, FTransform)const, ERASE_ARGUMENT_PACK(FTransform)) },
{ ERASE_METHOD_PTR(URigHierarchy, GetVectorArrayMetadata, (FRigElementKey, FName)const, ERASE_ARGUMENT_PACK(TArray<FVector>)) },
...
{ ERASE_METHOD_PTR(URigHierarchy, RestoreConnectorsFromStates, (TArray<FRigConnectorState>, bool), ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
{ ERASE_METHOD_PTR(URigHierarchy, RestoreSocketsFromStates, (TArray<FRigSocketState>, bool), ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
...
{ ERASE_METHOD_PTR(URigHierarchy, SetFloatArrayMetadata, (FRigElementKey, FName, TArray<float>), ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(URigHierarchy, SetInt32ArrayMetadata, (FRigElementKey, FName, TArray<int32>), ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(URigHierarchy, SetParentWeightArray, (FRigElementKey, TArray<FRigElementWeight>, bool, bool), ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(URigHierarchy, SortKeys, (const TArray<FRigElementKey>&)const, ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
...
{ ERASE_METHOD_PTR(UControlRigComponent, AddMappedSkeletalMesh, (USkeletalMeshComponent*, TArray<FControlRigComponentMappedBone>, TArray<FControlRigComponentMappedCurve>, const EControlRigComponentMapDirection), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UControlRigComponent, GetElementNames, (ERigElementType), ERASE_ARGUMENT_PACK(TArray<FName>)) },
...
{ ERASE_METHOD_PTR(UModularRigController, AutoConnectModules, (const TArray<FString>&, bool, bool), ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(UModularRigController, AutoConnectSecondaryConnectors, (const TArray<FRigElementKey>&, bool, bool), ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(UModularRigController, DisconnectCyclicConnectors, (bool), ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
...
{ ERASE_METHOD_PTR(URigHierarchyController, DuplicateElements, (TArray<FRigElementKey>, bool, bool, bool), ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
{ ERASE_METHOD_PTR(URigHierarchyController, ExportSelectionToText, ()const, ERASE_ARGUMENT_PACK(FString)) },
{ ERASE_METHOD_PTR(URigHierarchyController, ExportToText, (TArray<FRigElementKey>)const, ERASE_ARGUMENT_PACK(FString)) },
...
{ ERASE_METHOD_PTR(URigHierarchyController, ImportBones, (USkeleton*, FName, bool, bool, bool, bool, bool), ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
{ ERASE_METHOD_PTR(URigHierarchyController, ImportBonesFromAsset, (FString, FName, bool, bool, bool, bool), ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
{ ERASE_METHOD_PTR(URigHierarchyController, ImportCurves, (USkeleton*, FName, bool, bool, bool), ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
{ ERASE_METHOD_PTR(URigHierarchyController, ImportCurvesFromAsset, (FString, FName, bool, bool), ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
{ ERASE_METHOD_PTR(URigHierarchyController, ImportFromText, (FString, bool, bool, bool, bool), ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
{ ERASE_METHOD_PTR(URigHierarchyController, MirrorElements, (TArray<FRigElementKey>, FRigVMMirrorSettings, bool, bool, bool), ERASE_ARGUMENT_PACK(TArray<FRigElementKey>)) },
...
{ ERASE_METHOD_PTR(URigHierarchyController, SetSelection, (const TArray<FRigElementKey>&, bool), ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(UControlRigPoseAsset, GetControlNames, ()const, ERASE_ARGUMENT_PACK(TArray<FName>)) },
...
{ ERASE_METHOD_PTR(UControlRigBlueprint, ConvertHierarchyElementsToSpawnerNodes, (URigHierarchy*, TArray<FRigElementKey>, bool), ERASE_ARGUMENT_PACK(TArray<URigVMNode*>)) },
...
{ ERASE_METHOD_PTR(UNiagaraParticleCallbackHandler, ReceiveParticleData, (const TArray<FBasicParticleData>&, UNiagaraSystem*, const FVector&), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UNiagaraSimCache, GetEmitterNames, ()const, ERASE_ARGUMENT_PACK(TArray<FName>)) },
...
{ ERASE_METHOD_PTR(UNiagaraSimCache, ReadColorAttribute, (TArray<FLinearColor>, FName, FName, int32)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UNiagaraSimCache, ReadFloatAttribute, (TArray<float>, FName, FName, int32)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UNiagaraSimCache, ReadIDAttribute, (TArray<FNiagaraID>, FName, FName, int32)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UNiagaraSimCache, ReadIntAttribute, (TArray<int32>, FName, FName, int32)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UNiagaraSimCache, ReadPositionAttribute, (TArray<FVector>, FName, FName, bool, int32)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UNiagaraSimCache, ReadPositionAttributeWithRebase, (TArray<FVector>, FTransform, FName, FName, int32)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UNiagaraSimCache, ReadQuatAttribute, (TArray<FQuat>, FName, FName, bool, int32)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UNiagaraSimCache, ReadQuatAttributeWithRebase, (TArray<FQuat>, FQuat, FName, FName, int32)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UNiagaraSimCache, ReadVector2Attribute, (TArray<FVector2D>, FName, FName, int32)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UNiagaraSimCache, ReadVector4Attribute, (TArray<FVector4>, FName, FName, int32)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UNiagaraSimCache, ReadVectorAttribute, (TArray<FVector>, FName, FName, int32)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UNiagaraPythonEmitter, GetModules, ()const, ERASE_ARGUMENT_PACK(TArray<UNiagaraPythonModule*>)) },
...
{ ERASE_METHOD_PTR(UTakeRecorderSources, GetSourcesCopy, ()const, ERASE_ARGUMENT_PACK(TArray<UTakeRecorderSource*>)) },
...
{ ERASE_METHOD_PTR(UConstantQAnalyzer, GetCenterFrequencies, (TArray<float>), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UConstantQAnalyzer, GetNumCenterFrequencies, ()const, ERASE_ARGUMENT_PACK(const int32)) },
//END UConstantQAnalyzer

{ ERASE_METHOD_PTR(UConstantQNRT, GetChannelConstantQAtTime, (const float, const int32, TArray<float>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UConstantQNRT, GetNormalizedChannelConstantQAtTime, (const float, const int32, TArray<float>)const, ERASE_ARGUMENT_PACK(void)) },
//END UConstantQNRT
...
{ ERASE_METHOD_PTR(UOnsetNRT, GetChannelOnsetsBetweenTimes, (const float, const float, const int32, TArray<float>, TArray<float>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UOnsetNRT, GetNormalizedChannelOnsetsBetweenTimes, (const float, const float, const int32, TArray<float>, TArray<float>)const, ERASE_ARGUMENT_PACK(void)) },
//END UOnsetNRT

{ ERASE_METHOD_PTR(USynesthesiaSpectrumAnalyzer, GetCenterFrequencies, (const float, TArray<float>), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UCableComponent, GetCableParticleLocations, (TArray<FVector>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UMetaSoundBuilderBase, AddNode, (const TScriptInterface<IMetaSoundDocumentInterface>&, EMetaSoundBuilderResult), ERASE_ARGUMENT_PACK(FMetaSoundNodeHandle)) },
...
{ ERASE_METHOD_PTR(UMetaSoundBuilderBase, ConvertToPreset, (const TScriptInterface<IMetaSoundDocumentInterface>&, EMetaSoundBuilderResult), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UMetaSoundPatchBuilder, Build, (UObject*, const FMetaSoundBuilderOptions&)const, ERASE_ARGUMENT_PACK(TScriptInterface<IMetaSoundDocumentInterface>)) },
...
{ ERASE_METHOD_PTR(UMetaSoundSourceBuilder, Build, (UObject*, const FMetaSoundBuilderOptions&)const, ERASE_ARGUMENT_PACK(TScriptInterface<IMetaSoundDocumentInterface>)) },
...
{ ERASE_METHOD_PTR(UMetaSoundBuilderSubsystem, CreateFloatArrayMetaSoundLiteral, (const TArray<float>&, FName), ERASE_ARGUMENT_PACK(FMetasoundFrontendLiteral)) },
...
{ ERASE_METHOD_PTR(UMetaSoundBuilderSubsystem, CreateIntArrayMetaSoundLiteral, (const TArray<int32>&, FName), ERASE_ARGUMENT_PACK(FMetasoundFrontendLiteral)) },
...
{ ERASE_METHOD_PTR(UMetaSoundBuilderSubsystem, CreatePatchPresetBuilder, (FName, const TScriptInterface<IMetaSoundDocumentInterface>&, EMetaSoundBuilderResult), ERASE_ARGUMENT_PACK(UMetaSoundPatchBuilder*)) },
{ ERASE_METHOD_PTR(UMetaSoundBuilderSubsystem, CreateSourceBuilder, (FName, FMetaSoundBuilderNodeOutputHandle, FMetaSoundBuilderNodeInputHandle, TArray<FMetaSoundBuilderNodeInputHandle>, EMetaSoundBuilderResult, EMetaSoundOutputAudioFormat, bool), ERASE_ARGUMENT_PACK(UMetaSoundSourceBuilder*)) },
{ ERASE_METHOD_PTR(UMetaSoundBuilderSubsystem, CreateSourcePresetBuilder, (FName, const TScriptInterface<IMetaSoundDocumentInterface>&, EMetaSoundBuilderResult), ERASE_ARGUMENT_PACK(UMetaSoundSourceBuilder*)) },
...
{ ERASE_METHOD_PTR(UMetaSoundBuilderSubsystem, FindBuilderOfDocument, (TScriptInterface<IMetaSoundDocumentInterface>)const, ERASE_ARGUMENT_PACK(UMetaSoundBuilderBase*)) },
...
{ ERASE_METHOD_PTR(URadialSlider, SetValueTags, (const TArray<float>&), ERASE_ARGUMENT_PACK(void)) },
//END URadialSlider

{ ERASE_METHOD_PTR(UAudioMeter, GetMeterChannelInfo, ()const, ERASE_ARGUMENT_PACK(TArray<FMeterChannelInfo>)) },
...
{ ERASE_METHOD_PTR(UMetaSoundEditorSubsystem, BuildToAsset, (UMetaSoundBuilderBase*, FString, FString, FString, EMetaSoundBuilderResult, const USoundWave*), ERASE_ARGUMENT_PACK(TScriptInterface<IMetaSoundDocumentInterface>)) },
...
{ ERASE_METHOD_PTR(UProceduralMeshComponent, CreateMeshSection, (int32, const TArray<FVector>&, const TArray<int32>&, const TArray<FVector>&, const TArray<FVector2D>&, const TArray<FColor>&, const TArray<FProcMeshTangent>&, bool), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UProceduralMeshComponent, CreateMeshSection_LinearColor, (int32, const TArray<FVector>&, const TArray<int32>&, const TArray<FVector>&, const TArray<FVector2D>&, const TArray<FVector2D>&, const TArray<FVector2D>&, const TArray<FVector2D>&, const TArray<FLinearColor>&, const TArray<FProcMeshTangent>&, bool, bool), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UProceduralMeshComponent, UpdateMeshSection, (int32, const TArray<FVector>&, const TArray<FVector>&, const TArray<FVector2D>&, const TArray<FColor>&, const TArray<FProcMeshTangent>&), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UProceduralMeshComponent, UpdateMeshSection_LinearColor, (int32, const TArray<FVector>&, const TArray<FVector>&, const TArray<FVector2D>&, const TArray<FVector2D>&, const TArray<FVector2D>&, const TArray<FVector2D>&, const TArray<FLinearColor>&, const TArray<FProcMeshTangent>&, bool), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(USubmixEffectTapDelayPreset, GetTapIds, (TArray<int32>), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(USynthComponentMonoWaveTable, GetKeyFrameValuesForTable, (float)const, ERASE_ARGUMENT_PACK(TArray<float>)) },
...
{ ERASE_METHOD_PTR(UInterchangeAnimationTrackSetNode, GetCustomAnimationTrackUids, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeSkeletalAnimationTrackNode, GetMorphTargetNodeAnimationPayloadKeys, (TMap<FString,FString>, TMap<FString,uint8>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UInterchangeSkeletalAnimationTrackNode, GetSceneNodeAnimationPayloadKeys, (TMap<FString,FString>, TMap<FString,uint8>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeVariantSetNode, GetCustomDependencyUids, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeSceneVariantSetsNode, GetCustomVariantSetUids, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeMeshNode, GetMorphTargetDependencies, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeMeshNode, GetSceneInstanceUids, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeMeshNode, GetSkeletonDependencies, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UInterchangeMeshNode, GetSkeletonDependency, (const int32, FString)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UInterchangeMeshNode, GetSlotMaterialDependencies, (TMap<FString,FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeSceneNode, GetMorphTargetCurveWeights, (TMap<FString,float>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UInterchangeSceneNode, GetSlotMaterialDependencies, (TMap<FString,FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeSceneNode, GetSpecializedTypes, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeTexture2DNode, GetSourceBlocks, ()const, ERASE_ARGUMENT_PACK(TMap<int32,FString>)) },
...
{ ERASE_METHOD_PTR(UInterchangeLevelSequenceFactoryNode, GetCustomAnimationTrackUids, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeSceneVariantSetsFactoryNode, GetCustomVariantSetUids, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeTexture2DFactoryNode, GetSourceBlocks, ()const, ERASE_ARGUMENT_PACK(TMap<int32,FString>)) },
...
{ ERASE_METHOD_PTR(UInterchangeTexture2DFactoryNode, SetSourceBlocks, (const TMap<int32,FString>&), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeAnimSequenceFactoryNode, GetAnimatedAttributeCurveNames, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeAnimSequenceFactoryNode, GetAnimatedAttributeStepCurveNames, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeAnimSequenceFactoryNode, GetAnimatedMaterialCurveSuffixes, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeAnimSequenceFactoryNode, GetMorphTargetNodeAnimationPayloadKeys, (TMap<FString,FInterchangeAnimationPayLoadKey>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UInterchangeAnimSequenceFactoryNode, GetObjectClass, ()const, ERASE_ARGUMENT_PACK(UClass*)) },
{ ERASE_METHOD_PTR(UInterchangeAnimSequenceFactoryNode, GetSceneNodeAnimationPayloadKeys, (TMap<FString,FInterchangeAnimationPayLoadKey>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeMeshActorFactoryNode, GetSlotMaterialDependencies, (TMap<FString,FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeMeshFactoryNode, GetLodDataUniqueIds, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UInterchangeMeshFactoryNode, GetSlotMaterialDependencies, (TMap<FString,FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeSkeletalMeshLodDataNode, GetMeshUids, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeStaticMeshFactoryNode, GetSocketUids, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeStaticMeshLodDataNode, GetBoxCollisionMeshUids, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UInterchangeStaticMeshLodDataNode, GetBoxCollisionMeshUidsCount, ()const, ERASE_ARGUMENT_PACK(int32)) },
{ ERASE_METHOD_PTR(UInterchangeStaticMeshLodDataNode, GetCapsuleCollisionMeshUids, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UInterchangeStaticMeshLodDataNode, GetCapsuleCollisionMeshUidsCount, ()const, ERASE_ARGUMENT_PACK(int32)) },
{ ERASE_METHOD_PTR(UInterchangeStaticMeshLodDataNode, GetConvexCollisionMeshUids, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeStaticMeshLodDataNode, GetMeshUids, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangeStaticMeshLodDataNode, GetSphereCollisionMeshUids, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UInterchangePipelineMeshesUtilities, GetAllMeshGeometry, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UInterchangePipelineMeshesUtilities, GetAllMeshGeometryNotInstanced, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UInterchangePipelineMeshesUtilities, GetAllMeshInstanceUids, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UInterchangePipelineMeshesUtilities, GetAllMeshInstanceUidsUsingMeshGeometryUid, (FString, TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UInterchangePipelineMeshesUtilities, GetAllSkinnedMeshGeometry, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UInterchangePipelineMeshesUtilities, GetAllSkinnedMeshInstance, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UInterchangePipelineMeshesUtilities, GetAllStaticMeshGeometry, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UInterchangePipelineMeshesUtilities, GetAllStaticMeshInstance, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UActorActionUtility, GetSupportedClasses, ()const, ERASE_ARGUMENT_PACK(const TArray<TSoftClassPtr<UObject> >&)) },
//END UActorActionUtility

{ ERASE_METHOD_PTR(UAssetActionUtility, GetSupportedClass, ()const, ERASE_ARGUMENT_PACK(UClass*)) },
{ ERASE_METHOD_PTR(UAssetActionUtility, GetSupportedClasses, ()const, ERASE_ARGUMENT_PACK(const TArray<TSoftClassPtr<UObject> >&)) },
...
{ ERASE_METHOD_PTR(UEditorValidatorSubsystem, IsAssetValid, (const FAssetData&, TArray<FText>, TArray<FText>, const EDataValidationUsecase)const, ERASE_ARGUMENT_PACK(EDataValidationResult)) },
{ ERASE_METHOD_PTR(UEditorValidatorSubsystem, IsObjectValid, (UObject*, TArray<FText>, TArray<FText>, const EDataValidationUsecase)const, ERASE_ARGUMENT_PACK(EDataValidationResult)) },
{ ERASE_METHOD_PTR(UEditorValidatorSubsystem, RemoveValidator, (UEditorValidatorBase*), ERASE_ARGUMENT_PACK(void)) },
{ ERASE_METHOD_PTR(UEditorValidatorSubsystem, ValidateAssetsWithSettings, (const TArray<FAssetData>&, FValidateAssetsSettings, FValidateAssetsResults)const, ERASE_ARGUMENT_PACK(int32)) },
...
{ ERASE_METHOD_PTR(UEditorValidatorSubsystem, ValidateChangelists, (const TArray<UDataValidationChangelist*>, const FValidateAssetsSettings&, FValidateAssetsResults)const, ERASE_ARGUMENT_PACK(EDataValidationResult)) },
...
{ ERASE_METHOD_PTR(UPaperTileMapComponent, GetTilePolygon, (int32, int32, TArray<FVector>, int32, bool)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UPyTestObject, FuncTakingFieldPath, (const TFieldPath<FProperty>&), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UPyTestTypeHint, CheckFieldPathTypeHints, (const TFieldPath<FProperty>), ERASE_ARGUMENT_PACK(TFieldPath<FProperty>)) },
...
{ ERASE_METHOD_PTR(UPyTestTypeHint, CheckMapTypeHints, (const TMap<int32,FString>&, const TMap<int32,FName>&, const TMap<int32,FText>&, const TMap<int32,UObject*>&), ERASE_ARGUMENT_PACK(TMap<FString,UObject*>)) },
...
{ ERASE_METHOD_PTR(UMovieSceneScriptingActorReferenceChannel, GetKeys, ()const, ERASE_ARGUMENT_PACK(TArray<UMovieSceneScriptingKey*>)) },
{ ERASE_METHOD_PTR(UMovieSceneScriptingActorReferenceChannel, GetKeysByIndex, (const TArray<int32>&)const, ERASE_ARGUMENT_PACK(TArray<UMovieSceneScriptingKey*>)) },
...
{ ERASE_METHOD_PTR(UMovieSceneScriptingBoolChannel, EvaluateKeys, (FSequencerScriptingRange, FFrameRate)const, ERASE_ARGUMENT_PACK(TArray<bool>)) },
{ ERASE_METHOD_PTR(UMovieSceneScriptingBoolChannel, GetDefault, ()const, ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(UMovieSceneScriptingBoolChannel, GetKeys, ()const, ERASE_ARGUMENT_PACK(TArray<UMovieSceneScriptingKey*>)) },
{ ERASE_METHOD_PTR(UMovieSceneScriptingBoolChannel, GetKeysByIndex, (const TArray<int32>&)const, ERASE_ARGUMENT_PACK(TArray<UMovieSceneScriptingKey*>)) },
...
{ ERASE_METHOD_PTR(UMovieSceneScriptingByteChannel, GetKeys, ()const, ERASE_ARGUMENT_PACK(TArray<UMovieSceneScriptingKey*>)) },
{ ERASE_METHOD_PTR(UMovieSceneScriptingByteChannel, GetKeysByIndex, (const TArray<int32>&)const, ERASE_ARGUMENT_PACK(TArray<UMovieSceneScriptingKey*>)) },
...
{ ERASE_METHOD_PTR(UMovieSceneScriptingDoubleChannel, EvaluateKeys, (FSequencerScriptingRange, FFrameRate)const, ERASE_ARGUMENT_PACK(TArray<double>)) },
{ ERASE_METHOD_PTR(UMovieSceneScriptingDoubleChannel, GetDefault, ()const, ERASE_ARGUMENT_PACK(double)) },
{ ERASE_METHOD_PTR(UMovieSceneScriptingDoubleChannel, GetKeys, ()const, ERASE_ARGUMENT_PACK(TArray<UMovieSceneScriptingKey*>)) },
{ ERASE_METHOD_PTR(UMovieSceneScriptingDoubleChannel, GetKeysByIndex, (const TArray<int32>&)const, ERASE_ARGUMENT_PACK(TArray<UMovieSceneScriptingKey*>)) },
...
{ ERASE_METHOD_PTR(UMovieSceneScriptingEventChannel, GetKeys, ()const, ERASE_ARGUMENT_PACK(TArray<UMovieSceneScriptingKey*>)) },
{ ERASE_METHOD_PTR(UMovieSceneScriptingEventChannel, GetKeysByIndex, (const TArray<int32>&)const, ERASE_ARGUMENT_PACK(TArray<UMovieSceneScriptingKey*>)) },
...
{ ERASE_METHOD_PTR(UMovieSceneScriptingFloatChannel, EvaluateKeys, (FSequencerScriptingRange, FFrameRate)const, ERASE_ARGUMENT_PACK(TArray<float>)) },
{ ERASE_METHOD_PTR(UMovieSceneScriptingFloatChannel, GetDefault, ()const, ERASE_ARGUMENT_PACK(float)) },
{ ERASE_METHOD_PTR(UMovieSceneScriptingFloatChannel, GetKeys, ()const, ERASE_ARGUMENT_PACK(TArray<UMovieSceneScriptingKey*>)) },
{ ERASE_METHOD_PTR(UMovieSceneScriptingFloatChannel, GetKeysByIndex, (const TArray<int32>&)const, ERASE_ARGUMENT_PACK(TArray<UMovieSceneScriptingKey*>)) },
...
{ ERASE_METHOD_PTR(UMovieSceneScriptingIntegerChannel, EvaluateKeys, (FSequencerScriptingRange, FFrameRate)const, ERASE_ARGUMENT_PACK(TArray<int32>)) },
{ ERASE_METHOD_PTR(UMovieSceneScriptingIntegerChannel, GetDefault, ()const, ERASE_ARGUMENT_PACK(int32)) },
{ ERASE_METHOD_PTR(UMovieSceneScriptingIntegerChannel, GetKeys, ()const, ERASE_ARGUMENT_PACK(TArray<UMovieSceneScriptingKey*>)) },
{ ERASE_METHOD_PTR(UMovieSceneScriptingIntegerChannel, GetKeysByIndex, (const TArray<int32>&)const, ERASE_ARGUMENT_PACK(TArray<UMovieSceneScriptingKey*>)) },
...
{ ERASE_METHOD_PTR(UMovieSceneScriptingObjectPathChannel, GetKeys, ()const, ERASE_ARGUMENT_PACK(TArray<UMovieSceneScriptingKey*>)) },
{ ERASE_METHOD_PTR(UMovieSceneScriptingObjectPathChannel, GetKeysByIndex, (const TArray<int32>&)const, ERASE_ARGUMENT_PACK(TArray<UMovieSceneScriptingKey*>)) },
...
{ ERASE_METHOD_PTR(UMovieSceneScriptingStringChannel, GetKeys, ()const, ERASE_ARGUMENT_PACK(TArray<UMovieSceneScriptingKey*>)) },
{ ERASE_METHOD_PTR(UMovieSceneScriptingStringChannel, GetKeysByIndex, (const TArray<int32>&)const, ERASE_ARGUMENT_PACK(TArray<UMovieSceneScriptingKey*>)) },
...
{ ERASE_METHOD_PTR(USequencerCurveEditorObject, GetSelectedKeys, (const FSequencerChannelProxy&), ERASE_ARGUMENT_PACK(TArray<int32>)) },
...
{ ERASE_METHOD_PTR(USequencerCurveEditorObject, SelectKeys, (const FSequencerChannelProxy&, const TArray<int32>&), ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UImgMediaSource, GetProxies, (TArray<FString>)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UStaticMeshEditorSubsystem, BulkSetConvexDecompositionCollisions, (const TArray<UStaticMesh*>&, int32, int32, int32), ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(UStaticMeshEditorSubsystem, BulkSetConvexDecompositionCollisionsWithNotification, (const TArray<UStaticMesh*>&, int32, int32, int32, bool), ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(UStaticMeshEditorSubsystem, SetLodScreenSizes, (UStaticMesh*, const TArray<float>&), ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(USkeletonModifier, GetAllBoneNames, ()const, ERASE_ARGUMENT_PACK(TArray<FName>)) },
{ ERASE_METHOD_PTR(USkeletonModifier, GetBoneTransform, (const FName, const bool)const, ERASE_ARGUMENT_PACK(FTransform)) },
{ ERASE_METHOD_PTR(USkeletonModifier, GetChildrenNames, (const FName, const bool)const, ERASE_ARGUMENT_PACK(TArray<FName>)) },
...
{ ERASE_METHOD_PTR(USkinWeightModifier, GetVertexWeights, (const int32), ERASE_ARGUMENT_PACK(TMap<FName,float>)) },
...
{ ERASE_METHOD_PTR(USkinWeightModifier, SetVertexWeights, (const int32, const TMap<FName,float>&, const bool), ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(ULevelSequenceEditorSubsystem, PasteBindings, (FString, FMovieScenePasteBindingsParams, TArray<FMovieSceneBindingProxy>), ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(ULevelSequenceEditorSubsystem, PasteFolders, (FString, FMovieScenePasteFoldersParams, TArray<UMovieSceneFolder*>), ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(ULevelSequenceEditorSubsystem, PasteSections, (FString, FMovieScenePasteSectionsParams, TArray<UMovieSceneSection*>), ERASE_ARGUMENT_PACK(bool)) },
{ ERASE_METHOD_PTR(ULevelSequenceEditorSubsystem, PasteTracks, (FString, FMovieScenePasteTracksParams, TArray<UMovieSceneTrack*>), ERASE_ARGUMENT_PACK(bool)) },
...
{ ERASE_METHOD_PTR(UObjectMixerBlueprintObjectFilter, GetColumnsToExclude, ()const, ERASE_ARGUMENT_PACK(TSet<FName>)) },
{ ERASE_METHOD_PTR(UObjectMixerBlueprintObjectFilter, GetColumnsToShowByDefault, ()const, ERASE_ARGUMENT_PACK(TSet<FName>)) },
{ ERASE_METHOD_PTR(UObjectMixerBlueprintObjectFilter, GetForceAddedColumns, ()const, ERASE_ARGUMENT_PACK(TSet<FName>)) },
{ ERASE_METHOD_PTR(UObjectMixerBlueprintObjectFilter, GetObjectClassesToFilter, ()const, ERASE_ARGUMENT_PACK(TSet<UClass*>)) },
{ ERASE_METHOD_PTR(UObjectMixerBlueprintObjectFilter, GetObjectClassesToPlace, ()const, ERASE_ARGUMENT_PACK(TSet<TSubclassOf<AActor> >)) },
...
{ ERASE_METHOD_PTR(UObjectMixerBlueprintObjectFilter, GetPropertiesThatRequireListRefresh, ()const, ERASE_ARGUMENT_PACK(TSet<FName>)) },
...
{ ERASE_METHOD_PTR(UIKRetargeterController, AutoAlignBones, (const TArray<FName>&, const ERetargetAutoAlignMethod, ERetargetSourceOrTarget)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UIKRetargeterController, GetAllChainSettings, ()const, ERASE_ARGUMENT_PACK(const TArray<URetargetChainSettings*>&)) },
...
{ ERASE_METHOD_PTR(UIKRetargeterController, GetRetargetPoses, (const ERetargetSourceOrTarget)const, ERASE_ARGUMENT_PACK(TMap<FName,FIKRetargetPose>)) },
...
{ ERASE_METHOD_PTR(UIKRetargeterController, ResetRetargetPose, (const FName&, const TArray<FName>&, const ERetargetSourceOrTarget)const, ERASE_ARGUMENT_PACK(void)) },
...
{ ERASE_METHOD_PTR(UIKRigController, GetAllGoals, ()const, ERASE_ARGUMENT_PACK(const TArray<UIKRigEffectorGoal*>&)) },
...
{ ERASE_METHOD_PTR(UIKRigController, GetRetargetChains, ()const, ERASE_ARGUMENT_PACK(const TArray<FBoneChain>&)) },
